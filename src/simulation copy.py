...
def main():
    ...
    parser.add_argument("type", choices=['vary_cops_test', 'vary_sentence_test', 'vary_election_freq', 
                                        'vary_prosperity' ], help="Type of simulation to run: 'vary_cops' or 'vary_sentence' or 'vary_election_freq' or 'vary_prosperity'")
    ...
    elif args.type == 'vary_sentence_test':
