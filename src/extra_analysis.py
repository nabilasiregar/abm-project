...
def varying_trading_std():
    ...
    y_error =[min_crime, max_crime]
    plt.errorbar(StandardD, results_crime,
             yerr = y_error, 
             fmt ='o')
    ...
    plt.savefig('src/extra_graphs/final/Increase in trading skill gap vs amount of crimes commited 2.png')
    plt.close()
...
def varying_risk_std():
    ...
    plt.ylabel('average_amount_arrested')
    plt.savefig('src/extra_graphs/final/Increase in SD risk aversion vs amount of crimes commited 2.png')
    plt.close()
...
def wide_trade_police():
    ...
    plt.errorbar(starting_cops, results_crime,
             yerr = y_error, 
             fmt ='o')

    plt.savefig('src/extra_graphs/final/Change in starting cops for a wide trade skill with error.png')
    plt.close()
...
def wide_trade_sentence():
    ...
    for length in range(5,50,5):
        ...
        min_crime.append(average_crime - min(results_this_sd))
    y_error =[min_crime, max_crime]
    plt.errorbar(sentence_length, results_crime,
             yerr = y_error, 
             fmt ='o')
    ...
    plt.ylabel('average_amount_arrested')
    plt.savefig('src/extra_graphs/final/Change in sentence length for a wide trade skill.png')
    plt.close()
...
def wide_aversion_sentence():
    ...
    plt.xlabel('Sentence Length')
    plt.ylabel('average_amount_arrested')
    plt.savefig('src/extra_graphs/final/Change in sentence length for a wide risk aversion.png')
    plt.close()
...
def changing_sentence():
    ...
    plt.xlabel('Sentence length')
    plt.ylabel('average_amount_arrested')
    plt.savefig('src/extra_graphs/final/Change in sentence length vs crime rate.png')
    plt.close()
...
def change_tax_rate():
    ...
    for taxx in np.linspace(0.01,0.1,10):
        ...
        min_crime.append(average_crime - min(results_this_sd))
    y_error =[min_crime, max_crime]
    plt.errorbar(starting_taxx, results_crime,
             yerr = y_error, 
             fmt ='o')

    plt.scatter(starting_taxx, results_crime)
    plt.xlabel('Amount of starting tax')
    plt.ylabel('average_amount_arrested')
    plt.savefig('src/extra_graphs/final/Change in tax rate on crime.png')
    plt.close()
...
change_tax_rate_wide_trading()
change_tax_rate_wide_risk()